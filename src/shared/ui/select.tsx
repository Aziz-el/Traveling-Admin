...
export function CustomSelect({ name, options, value, onChange, placeholder = 'Выберите...', className = '' }: CustomSelectProps) {
...
className={`w-full px-4 py-2.5 flex items-center justify-between hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-colors text-left ${value === option.value ? 'bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-white'}`}
>
