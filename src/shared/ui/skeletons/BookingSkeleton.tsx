export default function BookingSkeleton() {
  return (
    ...
    ">
      <div className="
        w-full h-40 bg-gray-300 rounded-lg dark:bg-gray-700
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between mb-3">
          <div className="
            h-5 bg-gray-300 rounded dark:bg-gray-700
            w-2/3 md:w-1/3
          " />
        ...
        <div className="flex flex-wrap items-center gap-2 mb-3">
          ...
          <div className="w-20 h-5 bg-gray-300 rounded dark:bg-gray-700" />
          <div className="
            w-28 h-5 bg-gray-300 rounded dark:bg-gray-700
            hidden sm:block
          " />
        </div>
        ...
        ">
          ...
          <div className="
            w-32 h-4 bg-gray-300 rounded dark:bg-gray-700
            hidden md:block
          " />
        </div>
      </div>
